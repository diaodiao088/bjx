package com.bjxapp.worker.imagelist.imgsel.adapter;
...
public class ImageListAdapter extends EasyRVAdapter<Image> {
    ...
    private com.bjxapp.worker.imagelist.imgsel.common.OnItemClickListener listener;
    ...
    public void setOnItemClickListener(com.bjxapp.worker.imagelist.imgsel.common.OnItemClickListener listener) {
