...
import com.bjxapp.worker.push.XPushUtils;
...
public class XPushMessageReceiver extends PushMessageReceiver {
    /** TAG to Log */
    public static final String TAG = XPushMessageReceiver.class.getSimpleName();
    ...
    public void onBind(Context context, int errorCode, String appid, String userId, String channelId, String requestId) {
    	Log.d(TAG, "onBind"+channelId);
        if (errorCode == 0) {
        	ConfigManager.getInstance(context).setUserChannelID(channelId);
        }
    }
    ...
    public void onMessage(Context context, String message, String customContentString) {
    	Log.d(TAG, "onMessage-all"+message);
        if (Utils.isNotEmpty(message)) {
        	XPushUtils.parsePushMessage(context, message);
        }
    }
    ...
    public void onNotificationClicked(Context context, String title, String description, String customContentString) {
    	Log.d(TAG, "onNotificationClicked"+customContentString);
    	if (Utils.isNotEmpty(customContentString)) {           
            XPushUtils.parsePushNotificationClicked(context, customContentString);
        }
    }
    ...
    public void onNotificationArrived(Context context, String title, String description, String customContentString) {
    	...
    	if (Utils.isNotEmpty(customContentString)) {
        	XPushUtils.parsePushNotificationArrived(context, customContentString);
        }
    }
