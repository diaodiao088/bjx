...
package com.bjxapp.worker.SafeWebViewBridgeExample;
...
import com.bjxapp.worker.SafeWebViewBridge.JsCallback;
import com.bjxapp.worker.SafeWebViewBridgeExample.TaskExecutor;
...
public class HostJsScope {
    ...
    public static void toast (WebView webView, String message) {
    	...
    	//Utils.startActivity(webView.getContext(), CaptureActivity.class);
    }
    ...
    public static void alert (WebView webView, String message) {
        ...
        builder.setTitle("X System Message");
    ...
    public static String getIMSI (WebView webView) {
        String imsi = ((TelephonyManager) webView.getContext().getSystemService(Context.TELEPHONY_SERVICE)).getSubscriberId();
        return imsi;
    }
