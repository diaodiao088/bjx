...
public class CheckConfirmDialog {
    ...
    public CheckConfirmDialog(Context ctx) {
        this.mCtx = ctx;
        mDialog = new CustomLayoutDialog(ctx, R.layout.device_alert_dialog);
        initView();
    }
    ...
    public CheckConfirmDialog setOnNegativeListener(int resId, View.OnClickListener listener) {
    ...
    public CheckConfirmDialog setOnNegativeListener(String resId, View.OnClickListener listener) {
    ...
    public CheckConfirmDialog setOnPositiveListener(String resId, View.OnClickListener listener) {
    ...
    public CheckConfirmDialog setOnPositiveListener(int resId, View.OnClickListener listener) {
    ...
    public CheckConfirmDialog setOnCancelListener(DialogInterface.OnCancelListener listener) {
        mDialog.setOnCancelListener(listener);
        return this;
    }

    public CheckConfirmDialog setCancelable(boolean cancelable){
        mDialog.setCancelable(cancelable);
        return this;
    }

    public CheckConfirmDialog setTitle(int resId) {
    ...
    public CheckConfirmDialog setTitle(String txt) {
    ...
    public CheckConfirmDialog setContent(int resId) {
    ...
    public CheckConfirmDialog setContent(String content) {
    ...
    public CheckConfirmDialog setContentVisible(int visibility) {
        mContentTv.setVisibility(visibility);
        return this;
    }

    public CheckConfirmDialog setTitleVisible(int visibility) {
