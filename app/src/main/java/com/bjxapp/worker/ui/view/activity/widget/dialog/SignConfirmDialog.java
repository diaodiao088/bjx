...
public class SignConfirmDialog {
    ...
    public SignConfirmDialog(Context ctx) {
        this.mCtx = ctx;
        mDialog = new CustomLayoutDialog(ctx, R.layout.sign_alert_dialog);
        initView();
    }
    ...
    public SignConfirmDialog setOnNegativeListener(int resId, View.OnClickListener listener) {
    ...
    public SignConfirmDialog setOnNegativeListener(String resId, View.OnClickListener listener) {
    ...
    public SignConfirmDialog setOnPositiveListener(String resId, View.OnClickListener listener) {
    ...
    public SignConfirmDialog setOnPositiveListener(int resId, View.OnClickListener listener) {
    ...
    public SignConfirmDialog setOnCancelListener(DialogInterface.OnCancelListener listener) {
        mDialog.setOnCancelListener(listener);
        return this;
    }

    public SignConfirmDialog setCancelable(boolean cancelable){
        mDialog.setCancelable(cancelable);
        return this;
    }

    public SignConfirmDialog setTitle(int resId) {
    ...
    public SignConfirmDialog setTitle(String txt) {
    ...
    public SignConfirmDialog setContent(int resId) {
    ...
    public SignConfirmDialog setContent(String content) {
    ...
    public SignConfirmDialog setContentVisible(int visibility) {
        mContentTv.setVisibility(visibility);
        return this;
    }

    public SignConfirmDialog setTitleVisible(int visibility) {
