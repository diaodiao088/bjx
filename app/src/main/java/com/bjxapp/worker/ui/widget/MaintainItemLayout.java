...
public class MaintainItemLayout extends LinearLayout implements View.OnClickListener {
    ...
    public void bindData(MainTainBean maintainInfo) {
        ...
        if (maintainInfo.isOthers()) {
            ...
            double realPrice = Double.parseDouble(maintainInfo.getRengongCost()) + Double.parseDouble(maintainInfo.getLaborCost());

            mRealPriceTv.setText("¥" + realPrice + "/" + maintainInfo.getUnit());
        }
