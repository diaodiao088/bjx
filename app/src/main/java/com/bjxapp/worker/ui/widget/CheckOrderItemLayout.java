...
public class CheckOrderItemLayout extends LinearLayout {
    ...
    public void bindData(final int processState , final CheckDetailBean.DeviceBean itemBean, final String shopId, final boolean flag) {
        ...
        mSubStatusTv.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DeviceInfoActivity.goToActivity(getContext() , itemBean.getId() , processState <= 3 , flag);
            }
        });
