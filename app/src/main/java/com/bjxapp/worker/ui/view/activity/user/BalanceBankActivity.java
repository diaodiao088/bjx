...
public class BalanceBankActivity extends BaseActivity implements OnClickListener {
	...
	private XEditText mBankCardEdit,mBankNameEdit,mBankPersonEdit,mBankMobileEdit;
	...
	protected void initControl() {
		...
		mBankCardEdit = (XEditText) findViewById(R.id.balance_bank_card_edit);
		mBankNameEdit = (XEditText) findViewById(R.id.balance_bank_name_edit);
		mBankPersonEdit = (XEditText) findViewById(R.id.balance_bank_person_edit);
		mBankMobileEdit = (XEditText) findViewById(R.id.balance_bank_mobile_edit);
