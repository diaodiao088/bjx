...
public class BalanceBankWithdrawActivity extends BaseActivity implements OnClickListener {
	protected static final String TAG = "提现界面";
	private XTextView mRightTextView;
	...
	protected void initView() {
		mServiceEdit.setText("客服电话：" + getString(R.string.service_telephone_display));
	}
	...
	protected void setListener() {
		...
		mServiceEdit.setOnClickListener(this);
		mRightTextView.setOnClickListener(this);
		findViewById(R.id.balance_withdraw_balance_info_image).setOnClickListener(this);
	}
	...
	public void onClick(View v) {
		...
		case R.id.balance_withdraw_balance_info_image:
			showBalanceInfo();
			break;	
		case R.id.balance_withdraw_button_save:
			saveOperation();
		default:
			break;
		}
	...
	private void loadData() {
		...
		mLoadDataTask = new AsyncTask<String, Void, BankInfo>() {
	        ...
	        protected void onPostExecute(BankInfo result) {
	        	...
	        	mBankNameEdit.setText(result.getName());
	        	mBankPersonEdit.setText(result.getPerson());
	        	mBankMobileEdit.setText(result.getMobile());
