...
public class ChineseLetterParser {
	...
	private static ChineseLetterParser chineseLetterParser = new ChineseLetterParser();

	public static ChineseLetterParser getInstance() {
		return chineseLetterParser;
	}
