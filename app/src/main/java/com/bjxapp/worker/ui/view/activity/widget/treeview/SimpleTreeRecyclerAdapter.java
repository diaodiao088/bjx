package com.bjxapp.worker.ui.view.activity.widget.treeview;
...
public class SimpleTreeRecyclerAdapter extends TreeRecyclerAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.tree_list_item , parent ,false);
